...
<div class="content_scroll" style="width: 850px; ">
    ...
    <div id="reportContent">
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12">
                <h6 class="title" style="background:#ddd; text-align: center; font-size: 18px; font-weight: 900; padding: 5px; color: #bd4700;">Customer Payment Invoice</h6>
            </div>
        </div>
        <div class="row" style="margin-bottom: 20px;">
            <div class="text-center" style="margin-bottom: 10px;">
                <span class="invoice-header">Hospital Copy</span>
            </div>
            <div class="col-xs-12">
