...
<div id="testInvoiceReport" class="row">
  ...
  <div class="col-md-8 col-md-offset-2">
    <br>
    <test-invoice v-bind:report_id="selectedInvoice.id" v-if="showInvoice"></test-invoice>
  </div>
</div>
...
<script>
  ...
  new Vue({
    ...
    methods: {
      getReports() {
        axios.get("/get_report_list").then(res => {
